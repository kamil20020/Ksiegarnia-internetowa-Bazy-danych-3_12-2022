...
const Header = () => {
    ...
    return (
        <Grid container component="nav" alignItems="center">
            ...
            <Grid item xs={2} justifySelf="center" container justifyContent="center" alignSelf="center">
                <Typography component="h4" id="name" textAlign="center">
                    Bookshop
                </Typography>
            </Grid>
            <Grid item xs={5} justifySelf="end" container alignItems="center" justifyContent="end" columnSpacing={3}>
                {isUserLogged ? 
                    <React.Fragment>
                        <Grid item>
                            <Button
